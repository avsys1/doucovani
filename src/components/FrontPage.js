    ...
    <div className="bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 min-h-screen">
      ...
      <main className="container mx-auto mt-12 text-center">
        ...
        <p className="mt-4 text-xl text-gray-200">
          ...
          pulvinar eleifend sem. Aenean placerat. Curabitur sagittis hendrerit
          ante. Maecenas lorem.
        </p>
        ...
        <p className="mt-4 text-xl text-gray-200">
          ...
          possimus, omnis voluptas assumenda est, omnis dolor repellendus. Nulla
          pulvinar eleifend sem. Aenean placerat. Curabitur sagittis hendrerit
          ante. Maecenas lorem. Lorem ipsum dolor sit amet, consectetuer
          adipiscing elit. Vestibulum fermentum tortor id mi. Etiam sapien elit,
          consequat eget, tristique non, venenatis quis, ante. Suspendisse nisl.
          Nullam eget nisl. Phasellus rhoncus. Fusce dui leo, imperdiet in,
          aliquam sit amet, feugiat eu, orci. Nam libero tempore, cum soluta
          nobis est eligendi optio cumque nihil impedit quo minus id quod maxime
          placeat facere possimus, omnis voluptas assumenda est, omnis dolor
          repellendus. Nulla pulvinar eleifend sem. Aenean placerat. Curabitur
          sagittis hendrerit ante. Maecenas lorem.
        </p>
        <br></br>
      </main>
